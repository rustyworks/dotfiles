...
brew install ffmpeg graphicsmagick heroku htop imagemagick neovim phantomjs postgresql pyenv rbenv redis ruby-build sqlite the_silver_searcher tree unrar wget youtube-dl
